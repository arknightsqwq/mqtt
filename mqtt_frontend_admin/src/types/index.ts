...
export interface DeviceInfo { device_id: string; device_name: string; device_desc: string|null; config_json: any|null; field_labels: any|null; is_online: number; last_online_time: string|null; last_offline_time: string|null; bind_count: number }
